...
@Component({
  selector: 'app-personalize-menu', //tslint:disable-line
...
export class PersonalizeMenuComponent implements OnInit {
  ...
  public onChangeColors(ev: SohoChangeColorsPersonalizeEvent) {
    this.color = ev.data.colors;
    // Why is this coming in upper case?
    this.setSelectedColor(this.color.toLowerCase());
  }
